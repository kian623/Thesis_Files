...
playoffs = {}
playoffs['Conference Reset'] = simulate_SameRating_BackTo1500(
    {
        'k': 50,
        'revert': 1,
    }
)
playoffs['Season Reset'] = simulate_SameRating_BackTo1500Yearly(
    {
        'k':40,
        'revert': 0.53,
    }
)
playoffs['Modified Silver'] = simulate_SameRating(
    {
        'k': 12,
        'revert_season' : 1,
        'revert_conference' : 1
...
playoffs['Split Elo'] = simulate_SeparateRating(
    {
        'k': 25,
        'revert' : 1
    }
)
playoffs['Modified Split Elo'] = simulate_SeparateRating_PreviousRevert(
    {
        'k': 24,
        'revert' : 0.22,
        'revert_conference': 0.78
    }
)

for model in playoffs:
    print(f'{model}: {playoffs[model]}\n')