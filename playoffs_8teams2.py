"""
for calculating probability of a team to win each round for simulate2.py
"""
import math
...
def predict_wins_twice2_b05sf(teams):
    ...
    for key,value in series_wins.items():
        value.append(0) # last element of list for expected number of series wins
        for idx in range(3):
            value[3] += value[idx]
        value.insert(0,teams[key]) # first element of list for team rating
